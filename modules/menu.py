    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/M4STER-TOOL"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/Rajkumrdusad/M4STER-TOOL.git "+system.home+"/M4STER-TOOL")
            if os.path.exists(system.home+"/M4STER-TOOL/install.aex"):
              os.system("cd "+system.home+"/M4STER-TOOL && "+system.sudo+" sh install.aex")
              if os.path.exists(system.bin+"/M4STER-TOOL") and os.path.exists(system.conf_dir+"/M4STER-TOOL"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
              else:
            ...
            if os.path.exists(system.home+"/M4STER-TOOL"):
              ...
              os.system("git clone https://github.com/Rajkumrdusad/M4STER-TOOL.git "+system.home+"/M4STER-TOOL")
            if os.path.exists(system.home+"/M4STER-TOOL/install.aex"):
              os.system("cd "+system.home+"/M4STER-TOOL && sh install.aex")
              if os.path.exists(system.bin+"/M4STER-TOOL") and os.path.exists(system.conf_dir+"/M4STER-TOOL"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall tool-x" or cmd=="unistall M4STER-TOOL":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/M4STER-TOOL")
          os.system(system.sudo+" rm -rf "+system.bin+"/toolx")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/M4STER-TOOL")
        else:
          os.system("rm -rf "+system.bin+"/M4STER-TOOL")
          os.system("rm -rf "+system.bin+"/toolx")
          os.system("rm -rf "+system.conf_dir+"/M4STER-TOOL")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/M4STER-TOOL/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/M4STER-TOOL/core/cat.json") as cat_file:

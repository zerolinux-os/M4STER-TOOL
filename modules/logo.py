...
\033[1;33m
          ...
          |___  /               |___  /    
            ...
            / /  / _ \ '__/ _ \   / /\ \/ /
          ./ /__|  __/ | | (_) |./ /  >  < 
          \_____/\___|_|  \___/ \_/  /_/\_\ \033[1;91mv2.1
...
===============================================\033[00m''')
  ...
  def not_ins(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't install M4STER-TOOL.\033[1;m
...
\033[1;31m If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print ('''
\033[1;33m    [ + ] \033[1;32mM4STER-TOOL installed successfully.
\033[1;33m    [ + ] \033[1;32mTo run M4STER-TOOL.
\033[1;33m    [ + ] \033[1;32mType M4STER-TOOL in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mUpdate your M4STER-TOOL.
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mM4STER-TOOL Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def update_error(self):
    self.tool_header()
    print ('''
\033[1;31m  [ + ]  \033[1;31mWe can't Update M4STER-TOOL.\033[1;m
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
    self.tool_footer()
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Tool Name :- \033[1;32mM4STER-TOOL
\033[1;33m       [+] Author :- \033[1;32mZeroLinux ZERO7X
\033[1;33m       [+] Latest Update :- \033[1;32m18/2/2026.\033[1;m
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating M4STER-TOOL ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ 3 ] \033[1;32mUpdate M4STER-TOOL.
...
\033[1;33m  [ x ] \033[1;32mFor Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print ('''
\033[1;33m [✓] [1;32m Thanks for using the M4STER-TOOL tool

\033[1;33m [✓] [1;32m Goodbye, champ, see you later 👋😎

\033[1;33m [✓] [1;35m Remember: This is for educational purposes only ''')
    self.tool_footer()
